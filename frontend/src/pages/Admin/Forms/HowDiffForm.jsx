...
const HowDiffForm = ({ onRequestClose, refresh, editData, isNew }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/howDifferent", formData, {
        headers: {
  ...
  return (
    <ModalWrapper>
      <ModalContent>
        <ModalHeader>Mission Form</ModalHeader>
        <StyledForm onSubmit={isNew ? handleSubmit : handleUpdate}>
          ...
          <Button type="submit">Save How We Different Data</Button>
        </StyledForm>
      </ModalContent>
    </ModalWrapper>
  );
