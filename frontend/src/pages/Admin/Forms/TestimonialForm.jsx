...
const TestimonialFormModal = ({ onRequestClose, refresh, editData, isNew }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/testimonial", formData, {
        headers: {
  ...
  return (
    <ModalWrapper>
      <ModalContent>
        <ModalHeader>Save Testimonial</ModalHeader>
