...
const UseCaseFormModal = ({ onRequestClose, refresh, editData, isNew }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/usecasesub", formData);
  ...
  return (
    <ModalWrapper>
      <ModalContent>
        <ModalHeader>Save UseCase</ModalHeader>
        <StyledForm onSubmit={isNew ? handleSubmit : handleUpdate}>
          ...
          <Button type="submit">Save UseCase</Button>
        </StyledForm>
      </ModalContent>
    </ModalWrapper>
  );
