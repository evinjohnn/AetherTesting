...
const PlatformFormModal = ({ onRequestClose, refresh, editData, isNew }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/platformsub", formData);
  ...
  return (
    <ModalWrapper>
      <ModalContent>
        <ModalHeader>Save Platform</ModalHeader>
