...
import BlogFormModal from "./Forms/BlogForm";
  ...
  return (
    <Section>
      <div>
        {/* <Header>
          <h1>Manage Blogs</h1>
          <AddButton onClick={openModal}>Add New Blog</AddButton>
        </Header> */}
        <AdminButton
          head="manage Blogs"
          button="Add New Blog"
        ...
        <MainContent>
          ...
          ) : blog.length === 0 ? ( // Check if data is empty
                    ...
                    <Content className={hoveredIndex === index ? "active" : ""}>
                      ...
                      <P>
                        <p>
                          {readMore[index]
                            ? data.content
                            : trimDescription(data.content)}
                        </p>{" "}
                        {data.content && data.content.split(" ").length > 15 ? (
