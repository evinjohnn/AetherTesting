...
import AdminTechnology from "../Forms/AdminTechnology";
...
const Technology = () => {
  ...
  const fetchTechnology = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `/technologies/?page=${page}&limit=${limit}`
      );
      settechnology(response.data.data.technologys);
  ...
  const handleDelete = () => {
    deleteOperation("Technology", storedId);
    ...
    <Section>
      <div>
        ...
        <MainContent>
          ...
          ) : technology.length === 0 ? ( // Check if data is empty
