...
import upc3 from "../../assets/icons/sentimental.svg";
        ...
        <Container>
          ...
          <Upcoming>
            <UpcomingBox>
              ...
              <Text className="upcoming">NLP</Text>
            </UpcomingBox>
            <UpcomingBox>
              <IconContainer>
                <Icon src={upc2} alt="Upcoming" />
              </IconContainer>
              <Text className="upcoming">multilingual support</Text>
            </UpcomingBox>
            <UpcomingBox>
              <IconContainer>
                <Icon src={upc3} alt="Upcoming" />
              </IconContainer>
              <Text className="upcoming">sentimental analysis</Text>
            </UpcomingBox>
          </Upcoming>
        </Container>
      </div>
